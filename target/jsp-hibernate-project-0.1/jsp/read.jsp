...
<div align="center">
        ...
        <c:forEach var="user" items="${allUsers}">
            <tr>
                ...
                <td>
                    ...
                    <a href="/jsp_hibernate_project_war/admin/update?id=<c:out value='${user.id}' />">Update this
                        User</a>
                </td>
                <td>
                    <a href="/jsp_hibernate_project_war/admin/delete?id=<c:out value='${user.id}' />">Delete this
                        User</a>
                </td>
    ...
    <form action="/jsp_hibernate_project_war/admin/create">
